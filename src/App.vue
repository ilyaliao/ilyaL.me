...
<template>
  ...
  <Transition name="fade">
    <div v-if="imageModel" position="fixed top-0 left-0 right-0 bottom-0" z-500 backdrop-blur-7 @click="imageModel = undefined">
      <div position="absolute top-0 left-0 right-0 bottom-0" bg-black:30 z--1 />
